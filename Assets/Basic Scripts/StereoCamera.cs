// Unmodified StereoCamera script that we were provided for project 1
// Attach to main camera GO and uncheck the box on camera
// Wouldnt recommend using this until testing in VR
    // Just use main camera until then
